package com.scc.bukusakuonline.user.ui.detailpoint;
...
import com.scc.bukusakuonline.user.adapter.AdapterDetailPoint;
...
public class DetailPoint extends AppCompatActivity {
    ...
    @BindView(R.id.rv_point) RecyclerView mRecyclerView;
    @Override
